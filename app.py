...
class MainWindow(QMainWindow):
    ...
    def _build_tray(self) -> None:
        ...
        if menu is None:
            ...
            menu = QMenu()
        open_action = QAction("Abrir Timer Task", self)
    ...
    def closeEvent(self, event: QCloseEvent) -> None:
        ...
        self.tray.showMessage(
            APP_NAME,
            "O Timer Task continua ativo na bandeja do Windows.",
...
def main() -> int:
    ...
    if not instance_lock.tryLock(100):
        QMessageBox.information(
            None,
            APP_NAME,
            "O Timer Task já está aberto. Verifique o ícone na bandeja do Windows.",
        )
        return 0
    ...
    window.show()
    logging.info("Timer Task iniciado")
