...
- não inclua CSVs, SQLite, logs ou capturas com dados reais;
...
git init
git add .
git commit -m "feat: publica versão inicial do Timer Task"
git branch -M main
...
- descrição: `Aplicativo Windows simples para registro de tarefas e tempo com SQLite local e CSV compartilhado.`
