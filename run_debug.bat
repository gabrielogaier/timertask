...
echo.
echo Iniciando Timer Task em modo debug...
echo O terminal permanecera aberto para exibir mensagens e erros.
echo.
"%VENV_PYTHON%" "%CD%\app.py"
set "EXIT_CODE=%ERRORLEVEL%"
echo.
echo Timer Task encerrado. Codigo de saida: %EXIT_CODE%
pause
exit /b %EXIT_CODE%
